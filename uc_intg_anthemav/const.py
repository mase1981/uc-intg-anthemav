...
CMD_MAX_VOL = "GCMMV"  # + -40 to 10 (main zone Maximum Volume ceiling)
CMD_MAX_VOL_QUERY = "GCMMV?"
CMD_MASTER_VOL_SCALE = "GCMVS"  # + 0 (per cent) / 1 (dB)
CMD_MASTER_VOL_SCALE_QUERY = "GCMVS?"
